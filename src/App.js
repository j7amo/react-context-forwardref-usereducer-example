...
function App() {
  // after extracting AUTH logic into AuthContextProvider component we don't need this state slice here
  ...
  // after extracting AUTH logic into AuthContextProvider component we don't need these functions here
  ...
  // return (
  //   // let's say we need the auth-context in all app components: in this case we wrap everything with AuthContext.Provider
  //   <AuthContext.Provider
  //     // and we pass the state that we want to access later in some child components in a 'VALUE' prop
  //     value={{
  ...
  // after extracting AUTH logic into AuthContextProvider component we don't have to explicitly pass any props anymore
